...
switch user
    case 'Gergely'
        fpath    = 'C:\Users\Gergely\Documents\DATA\Spikes\eMouse\'; % where on disk do you want the simulation? ideally and SSD...
        if ~exist(fpath, 'dir'); mkdir(fpath); end
        
        addpath(genpath('C:\Users\Gergely\Documents\MATLAB\KiloSort-master')) % path to kilosort folder
        addpath(genpath('C:\Users\Gergely\Documents\MATLAB\npy-matlab-master\npy-matlab')) % path to npy-matlab scripts
        pathToYourConfigFile = 'C:\Users\Gergely\Documents\MATLAB\KiloSort-master\eMouse'; % for this example it's ok to leave this path inside the repo, but for your own config file you *must* put it somewhere else!
